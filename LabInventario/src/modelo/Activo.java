...
public abstract class Activo {
    ...
    // Métodos para evitar instanceof (Cumple OCP)
    public abstract String getTipo();
    public abstract Integer getMesesUso();
    public abstract Integer getMesesVigencia();
    public abstract Integer getEsCritico();
}